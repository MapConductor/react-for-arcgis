...
__export(index_exports, {
  ArcGISDesign: () => ArcGISDesign,
  ArcGISMapProvider: () => ArcGISMapProvider,
  ArcGISMapView: () => ArcGISMapView,
  ArcGISMapView2D: () => ArcGISMapView2D,
  ArcGISMapViewController: () => ArcGISMapViewController,
  ArcGISMapViewState: () => ArcGISMapViewState,
  ZoomAltitudeConverter: () => ZoomAltitudeConverter,
  arcGISScaleToZoom: () => arcGISScaleToZoom,
  arcGISZoomToScale: () => arcGISZoomToScale,
  useArcGISViewState: () => useArcGISViewState
});
module.exports = __toCommonJS(index_exports);

// src/ArcGISMapProvider.ts
var import_js_sdk_core11 = require("@mapconductor/js-sdk-core");

// src/ArcGISMapViewController.ts
var import_js_sdk_core = require("@mapconductor/js-sdk-core");
...
// src/ArcGISMapViewController.ts
var import_Basemap = __toESM(require("@arcgis/core/Basemap"));
...
var ArcGISMapViewController = class extends import_js_sdk_core.BaseMapViewController {
  ...
  setMapDesignType(value) {
    ...
    if (map) {
      map.basemap = new import_Basemap.default({
  ...
  setupEventListeners() {
    ...
    const handleClick = async (event) => {
      ...
      if (!position) return;
      const point = (0, import_js_sdk_core.createGeoPoint)({
  ...
  getCameraPosition() {
    if (this.holder.map.type === "2d") {
      ...
      return (0, import_js_sdk_core.createMapCameraPosition)({
        position: (0, import_js_sdk_core.createGeoPoint)({
  ...
  getVisibleRegion() {
    ...
    const bounds = (0, import_js_sdk_core.createGeoRectBounds)();
    bounds.extend((0, import_js_sdk_core.createGeoPoint)({
    ...
    return {
      bounds,
      nearLeft: (0, import_js_sdk_core.createGeoPoint)({
        latitude: extent.ymin,
        longitude: extent.xmin
      }),
      nearRight: (0, import_js_sdk_core.createGeoPoint)({
        latitude: extent.ymin,
        longitude: extent.xmax
      }),
      farLeft: (0, import_js_sdk_core.createGeoPoint)({
        latitude: extent.ymax,
        longitude: extent.xmin
      }),
      farRight: (0, import_js_sdk_core.createGeoPoint)({
        latitude: extent.ymax,
        longitude: extent.xmax
      })
    };
...
var import_js_sdk_core2 = require("@mapconductor/js-sdk-core");
var ArcGISViewHolder = class extends import_js_sdk_core2.MapViewHolderBase {
  ...
  fromScreenOffsetSync(offset) {
    try {
      ...
      return (0, import_js_sdk_core2.createGeoPoint)({
...
var import_js_sdk_core4 = require("@mapconductor/js-sdk-core");

// src/marker/AbstractArcGISController.ts
var import_js_sdk_core3 = require("@mapconductor/js-sdk-core");
var AbstractArcGISController = class extends import_js_sdk_core3.AbstractMarkerController {
  constructor(renderer, _tilingOptions = import_js_sdk_core3.MarkerTilingOptions.Default) {
    super({
      markerManager: import_js_sdk_core3.MarkerManager.defaultManager(
        null,
...
var ArcGISMarkerController = class extends AbstractArcGISController {
  constructor(renderer, tilingOptions = import_js_sdk_core4.MarkerTilingOptions.Default) {
...
var import_js_sdk_core5 = require("@mapconductor/js-sdk-core");
var ArcGISCircleOverlayController = class extends import_js_sdk_core5.CircleController {
  constructor(renderer) {
    super({
      circleManager: new import_js_sdk_core5.CircleManager(),
      renderer
    });
  }
  async composition(data) {
...
var import_js_sdk_core6 = require("@mapconductor/js-sdk-core");
var ArcGISPolylineOverlayController = class extends import_js_sdk_core6.PolylineController {
  constructor(renderer) {
    super({
      polylineManager: new import_js_sdk_core6.PolylineManager(),
      renderer
    });
  }
  async composition(data) {
...
var import_js_sdk_core7 = require("@mapconductor/js-sdk-core");
var ArcGISPolygonOverlayController = class extends import_js_sdk_core7.PolygonController {
  constructor(renderer) {
    super({
      polygonManager: new import_js_sdk_core7.PolygonManager(),
      renderer
    });
  }
  async composition(data) {
...
var import_js_sdk_core8 = require("@mapconductor/js-sdk-core");
var ArcGISGroundImageController = class extends import_js_sdk_core8.GroundImageController {
  constructor(renderer) {
    super({
      groundImageManager: new import_js_sdk_core8.GroundImageManager(),
      renderer
    });
  }
  async composition(data) {
...
var import_js_sdk_core9 = require("@mapconductor/js-sdk-core");
var ArcGISRasterLayerController = class extends import_js_sdk_core9.RasterLayerController {
  constructor(renderer) {
    super({
      rasterLayerManager: new import_js_sdk_core9.RasterLayerManager(),
      renderer
    });
  }
  async composition(data) {
...
var import_Graphic = __toESM(require("@arcgis/core/Graphic"));
var ArcGISCircleOverlayRenderer = class {
  ...
  createCircle(entity) {
    ...
    const graphic = new import_Graphic.default({
      geometry: point,
      symbol: circleSymbol,
      attributes: {
        id: state.id
...
var import_Graphic2 = __toESM(require("@arcgis/core/Graphic"));
var ArcGISMarkerRenderer = class {
  ...
  createMarker(entity) {
    ...
    const graphic = new import_Graphic2.default({
      geometry: point,
      symbol: markerSymbol,
      attributes: {
        id: state.id
...
var import_Graphic3 = __toESM(require("@arcgis/core/Graphic"));
var ArcGISPolylineOverlayRenderer = class {
  ...
  createPolyline(entity) {
    ...
    const graphic = new import_Graphic3.default({
      geometry: polyline,
      symbol: lineSymbol,
      attributes: {
        id: state.id
...
var import_Graphic4 = __toESM(require("@arcgis/core/Graphic"));
var ArcGISPolygonOverlayRenderer = class {
  ...
  createPolygon(entity) {
    ...
    const graphic = new import_Graphic4.default({
      geometry: polygon,
      symbol: fillSymbol,
      attributes: {
        id: state.id
...
var import_Graphic5 = __toESM(require("@arcgis/core/Graphic"));
var ArcGISGroundImageOverlayRenderer = class {
  ...
  createGroundImage(entity) {
    ...
    const graphic = new import_Graphic5.default({
      geometry: polygon,
      symbol: fillSymbol,
      attributes: {
        id: state.id
...
var import_WebTileLayer = __toESM(require("@arcgis/core/layers/WebTileLayer"));
var ArcGISRasterLayerOverlayRenderer = class {
  ...
  async createRasterLayer(entity) {
    ...
    try {
      const rasterLayer = new import_WebTileLayer.default({
        urlTemplate
      });
...
var import_js_sdk_core10 = require("@mapconductor/js-sdk-core");
var degToRad = (deg) => deg * Math.PI / 180;
var _ZoomAltitudeConverter = class _ZoomAltitudeConverter extends import_js_sdk_core10.AbstractZoomAltitudeConverter {
  ...
  cosLatitudeFactor(latitude) {
    ...
    return Math.max(import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_COS_LAT, Math.abs(Math.cos(latRad)));
  }
  cosTiltFactor(tilt) {
    const clamped = Math.max(0, Math.min(90, tilt));
    const tiltRad = clamped * Math.PI / 180;
    return Math.max(import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_COS_TILT, Math.cos(tiltRad));
  }
  zoomLevelToAltitude({
    zoomLevel,
    latitude,
    ...
    return Math.min(Math.max(altitude, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ALTITUDE), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ALTITUDE);
  }
  altitudeToZoomLevel({
    altitude,
    latitude,
    ...
    const clampedAltitude = Math.min(Math.max(altitude, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ALTITUDE), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ALTITUDE);
    const cosTilt = this.cosTiltFactor(tilt);
  ...
  zoomLevelToDistance({
    ...
    const clampedZoom = Math.min(Math.max(zoomLevel, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ZOOM_LEVEL), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ZOOM_LEVEL);
    const cosLat = this.cosLatitudeFactor(latitude);
    const distance = this.effectiveZoom0Altitude() * cosLat / Math.pow(import_js_sdk_core10.AbstractZoomAltitudeConverter.ZOOM_FACTOR, clampedZoom);
    return Math.min(Math.max(distance, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ALTITUDE), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ALTITUDE);
  }
  distanceToZoomLevel({
    distance,
    latitude
  }) {
    const clampedDistance = Math.min(Math.max(distance, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ALTITUDE), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ALTITUDE);
    const cosLat = this.cosLatitudeFactor(latitude);
    const zoomLevel = Math.log2(this.effectiveZoom0Altitude() * cosLat / clampedDistance);
    return Math.min(Math.max(zoomLevel, import_js_sdk_core10.AbstractZoomAltitudeConverter.MIN_ZOOM_LEVEL), import_js_sdk_core10.AbstractZoomAltitudeConverter.MAX_ZOOM_LEVEL);
  }
...
// src/ArcGISMapProvider.ts
var ArcGISMapProvider = class extends import_js_sdk_core11.MapProvider {
  constructor() {
    super(...arguments);
...
var import_main = require("@arcgis/core/assets/esri/themes/light/main.css");
var import_js_sdk_react = require("@mapconductor/js-sdk-react");
...
function ArcGISMapView({
  ...
  const [provider] = (0, import_react.useState)(() => new ArcGISMapProvider());
  const [scope] = (0, import_react.useState)(() => new import_js_sdk_react.MapViewScope());
  const [controller, setController] = (0, import_react.useState)(null);
  const [isReady, setIsReady] = (0, import_react.useState)(false);
  const bridgeUnsubs = (0, import_react.useRef)([]);
  const typedControllerRef = (0, import_react.useRef)(null);
  const [bubbleEntries, setBubbleEntries] = (0, import_react.useState)([]);
  const [animationEntries, setAnimationEntries] = (0, import_react.useState)([]);
  const [cameraTick, setCameraTick] = (0, import_react.useState)(0);
  const [initializationError, setInitializationError] = (0, import_react.useState)(null);
  const missingApiKey = !state.apiKey?.trim();
  const onMapLoadedRef = (0, import_react.useRef)(onMapLoaded);
  const onMapClickRef = (0, import_react.useRef)(onMapClick);
  const onMapLongClickRef = (0, import_react.useRef)(onMapLongClick);
  const onCameraMoveStartRef = (0, import_react.useRef)(onCameraMoveStart);
  const onCameraMoveRef = (0, import_react.useRef)(onCameraMove);
  const onCameraMoveEndRef = (0, import_react.useRef)(onCameraMoveEnd);
  ...
  void cameraTick;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_js_sdk_react.MapContext.Provider, { value: { controller, isReady }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      (missingApiKey || initializationError) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          role: "alert",
          style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_js_sdk_react.MapAttributionOverlay,
        {
          scope,
      ...
      animationEntries.length > 0 && typedControllerRef.current && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_js_sdk_react.MarkerAnimationLayer,
        {
          entries: animationEntries,
          resolveScreenOffset: (entry) => typedControllerRef.current.holder.toScreenOffset(entry.state.position)
        }
      ),
      bubbleEntries.length > 0 && typedControllerRef.current && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden" }, children: bubbleEntries.map((entry) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_js_sdk_react.InfoBubbleOverlay,
          {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_js_sdk_react.MapViewScopeProvider, { scope, children })
  ] });
}
function ArcGISMapView2D(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArcGISMapView, { ...props, useSceneView: false });
}

// src/ArcGISMapViewState.ts
var import_react2 = require("react");
var import_js_sdk_core12 = require("@mapconductor/js-sdk-core");
var ArcGISMapViewState = class extends import_js_sdk_core12.MapViewState {
  constructor({
    id = (0, import_js_sdk_core12.createRandomId)(),
    apiKey = "",
    mapDesignType = ArcGISDesign.Streets,
    cameraPosition = import_js_sdk_core12.MapCameraPosition.Default
  } = {}) {
    super();
    this.controller = null;
...
function useArcGISViewState(params = {}) {
  const [state] = (0, import_react2.useState)(() => new ArcGISMapViewState(params));
  return state;
}
